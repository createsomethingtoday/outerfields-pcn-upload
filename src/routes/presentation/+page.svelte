...
<Presentation title="OUTERFIELDS" subtitle="Premium Content Network">
	...
	<Slide type="content">
		...
		<p>
			A <span class="highlight">premium content network</span> you control—content, membership, and analytics in one place.
		</p>
		<ul>
	...
	<!-- ═══════════════════════════════════════════════════════════════════
	     SLIDE 6: AI Analytics Assistant (component)
	     ═══════════════════════════════════════════════════════════════════ -->
	<Slide type="image">
	...
	<!-- ═══════════════════════════════════════════════════════════════════
	     SLIDE 7: Analytics Dashboard (component)
	     ═══════════════════════════════════════════════════════════════════ -->
	<Slide type="image">
		...
		<p class="caption">One dashboard: video engagement, social metrics, and project progress.</p>
	</Slide>
