  ...
  const components: Component[] = [
    {
      ...
      name: 'Content Engine',
      description:
        'The heart of your platform. Upload, organize, and deliver content with enterprise-grade reliability.',
      icon: 'video_library',
    ...
    },
    {
      ...
      description:
        'Flexible revenue models that adapt to your business. From subscriptions to one-time purchases.',
      icon: 'payments',
    ...
    },
    {
      ...
      name: 'Community Hub',
      description:
        'Build lasting relationships with your audience. Forums, comments, and direct messaging.',
      icon: 'groups',
    ...
    },
    {
      ...
      description:
        'Global infrastructure that scales with you. 99.9% uptime, worldwide performance.',
      icon: 'public',
