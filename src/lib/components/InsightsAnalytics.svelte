<script lang="ts">
  ...
  function buildAnalyticsContext() {
    return {
      title: dashboardData.videoEngagement?.topVideo ?? 'Top Performing Video',
      views:
        dashboardData.videoEngagement?.totalViews !== undefined
          ? dashboardData.videoEngagement.totalViews.toLocaleString()
          : 'N/A',
      engagement:
        dashboardData.instagram?.engagement !== undefined
          ? `${dashboardData.instagram.engagement}%`
          : 'N/A',
      avgWatch: dashboardData.videoEngagement?.avgWatchTime ?? 'N/A'
    };
  }
  ...
  async function askQuestion(question: string) {
    ...
    try {
      const res = await fetch('/api/analytics-chat-claude', {
        ...
        body: JSON.stringify({
          message: question,
          videoAnalytics: buildAnalyticsContext()
        })
      });
  ...
  <div class="insights-container">
    ...
    <div class="section-header">
      ...
      <p class="section-description">
        Every PCN includes real-time analytics and an AI-powered assistant. Video engagement, social
        metrics, project progress—plus the ability to ask your data questions in plain English and
        ...
        <div class="metrics-grid">
          ...
          <div class="metric-card">
            ...
            <div class="metric-stats">
              ...
              <div class="stat-secondary">
                ...
                <div class="stat-item">
                  <span class="stat-value"
                    >{dashboardData.videoEngagement?.completionRate ?? 73}%</span
                  >
          ...
          <div class="metric-card">
            ...
            <div class="metric-stats">
              ...
              <div class="stat-secondary">
                <div class="stat-item">
                  <span class="stat-value">{dashboardData.instagram?.engagement ?? '4.8'}%</span>
          ...
          <div class="metric-card">
            ...
            <div class="metric-stats">
              ...
              <div class="stat-secondary">
                <div class="stat-item">
                  <span class="stat-value">{dashboardData.clickup?.completedToday ?? 7}</span>
                  <span class="stat-label">Completed Today</span>
                </div>
                <div class="stat-item">
                  <span class="stat-value">{dashboardData.clickup?.progress ?? 64}%</span>
    ...
    <div class="ai-section">
      ...
      <div class="demo-preview">
        ...
        <div class="demo-cta">
          <p class="demo-cta-text">This capability is built into every PCN with no extra setup.</p>
        </div>
      </div>
    </div>
  </div>
