				...
				<tbody>
					{#each features as feature}
						<tr>
							...
							<td class="value-cell">
								{#if feature.outerfields === true}
									<span class="check-icon success">
										<CheckCircle size={24} />
									</span>
								{:else if typeof feature.outerfields === 'string'}
									<span class="value-text coming">{feature.outerfields}</span>
								{:else}
